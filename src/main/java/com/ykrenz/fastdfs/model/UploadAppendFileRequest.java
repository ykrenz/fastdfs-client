 ...
 * @date 2022/1/22
 */
public class UploadAppendFileRequest extends AbstractFileExtHandlerArgs {
     ...
     * 参数构建类
     */
    public static final class Builder extends AbstractFileExtHandlerArgs.Builder<Builder, UploadAppendFileRequest> {
